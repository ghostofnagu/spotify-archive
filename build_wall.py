...
<title>Permanent Record — Your Listening Life</title>
<style>
...
<section class="hero" aria-label="A moving stream of artist portraits">
  <div class="hero-copy">
    ...
    <p>The music that stays with you, held in one enduring record.</p>
  </div>
...
<footer class="archive-footer">
  <div>
    <div class="smallcaps">A personal listening archive</div>
    <h1>Permanent Record <em>— your listening life, kept</em></h1>
  </div>
  <div class="footer-bottom smallcaps">
    <p>Artwork, artist portraits, listening history and previews · hover to listen · click to find a release</p>
